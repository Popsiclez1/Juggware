...
def cleanup_manual_offsets_directory(offsets_dir):
    """Remove all files from the manual offsets output directory except the core offset files."""
    ...
    try:
        for entry in os.listdir(offsets_dir):
            ...
            try:
                ...
                debug_log(f"Failed to remove manual offsets entry {entry_path}: {str(e)}", "WARNING")
    except Exception as e:
        debug_log(f"Failed to cleanup manual offsets directory {offsets_dir}: {str(e)}", "WARNING")
...
def on_create_offsets_clicked():
    ...
    def create_offsets_thread():
        ...
        try:
            ...
            try:
                cleanup_manual_offsets_directory(output_folder)
            except Exception:
                pass
