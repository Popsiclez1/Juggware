            ...
            if cs2_check_counter >= 60:  # Check every ~60 frames
                ...
                if not is_cs2_running():
                    ...
                    if result == 6:  # IDYES
                        ...
                        app_state["switch_to_cheat"] = False
                        app_state["switch_to_loader"] = False
                        # Perform immediate temp cleanup in this exit path.
                        try:
                            cleanup_temp_folder()
                        except Exception:
                            pass
...
def cleanup_temp_folder():
    ...
    # Stop external radar window if running
    stop_external_radar_window()

    # Stop spectator list window if running
    stop_spectator_list_thread()
    ...
    # Stop bhop thread if running
    stop_bhop_thread()
    
    # Stop anti-AFK thread if running
    stop_anti_afk_thread()

    # Stop shared memory thread if running
    stop_memory_thread()
