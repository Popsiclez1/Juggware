...
def render_esp_frame(overlay, pm, client, settings):
    ...
    for i in range(1, 64):
        try:
            ...
            if settings.get('weapon_esp', False) and not (settings.get('hide_spotted_players', False) and is_spotted):
                try:
